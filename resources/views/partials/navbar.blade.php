<nav class="navbar" aria-label="Main navigation">
            ...
            <div class="mobile-nav" id="mobileNav" aria-hidden="true">
                ...
                <div class="mobile-nav-body">
                    ...
                    <div class="mobile-nav-section">
                        <h4>Explore</h4>
                        <a href="{{ route('public.event-types') }}" class="mobile-nav-link">
                        ...
                        {{-- "Events" pointed at the same page as the link three
                             rows up, in the same menu section — one destination
                             under two names. Removed. --}}
    ...
    <div class="navbar-row navbar-row-links">
        <div class="container">
            ...
            <li><a href="{{ route('public.event-types') }}" class="{{ request()->routeIs('public.event-types') ? 'is-active' : '' }}">Event Types</a></li>
