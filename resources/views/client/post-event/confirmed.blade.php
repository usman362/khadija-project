    ...
    <div class="pe-container pe-main">
        ...
        <div style="display:flex; align-items:flex-start; justify-content:space-between; gap:18px; flex-wrap:wrap; margin-bottom:22px;">
            ...
            <div style="display:flex; align-items:center; gap:10px; flex-wrap:wrap;">
                {{-- Removed 2026-08-14 for the reason the button below it was
                     removed on 2026-08-05, which this one was left out of:
                     the order here is representative, and there is no receipt
                     route in the app to open even when it is not. --}}
                {{-- Removed 2026-08-05: this page's order is representative data, so
                     there is no order to open. A dead button reads as a broken
                     site; restore it when orders are stored for real. --}}
            </div>
        </div>
