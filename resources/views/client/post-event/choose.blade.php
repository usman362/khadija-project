...
<div class="pe-wrap">
    <div class="pe-container pe-main" style="padding-top:26px; padding-bottom:40px;">
        ...
        @php
            ...
            // DIR-1 (Khadijah): request types read A to Z. Sorted here rather
            // than written in order, so a route added later cannot land in the
            // wrong place — which is how the hand-written order drifted from
            // the sidebar's in the first place.
            usort($routes, fn ($a, $b) => strcmp($a['title'], $b['title']));
        @endphp
