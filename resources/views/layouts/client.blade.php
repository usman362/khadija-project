    ...
    <aside class="cl-sidebar" id="sidebar">
        ...
        <nav class="cl-sidebar-nav">
            <ul style="list-style:none; padding:0;">
                ...
                <li class="cl-nav-item">
                    {{-- One entry, not two. SSR and MSR are the scope of a bidding
                         request, not separate types — the wizard decides which it is
                ...
                <li class="cl-nav-item">
                    <a href="{{ route('client.saved-professionals.index') }}" class="cl-nav-link {{ request()->routeIs('client.saved-professionals.*') ? 'active' : '' }}">
                        <svg class="cl-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="m22 11-3 3-2-2"/></svg>
                        My Professionals
                    </a>
                </li>
                <li class="cl-nav-item">
                ...
                <li class="cl-nav-item">
                    <a href="{{ route('client.spending.index') }}" class="cl-nav-link {{ request()->routeIs('client.spending.*') ? 'active' : '' }}">
                ...
                <li class="cl-nav-item">
                    <a href="{{ route('client.reports.index') }}" class="cl-nav-link {{ request()->routeIs('client.reports.*') ? 'active' : '' }}">
                ...
                {{-- Rule R34 — both parties reach the same module. --}}
                <li class="cl-nav-item">
                ...
                <li class="cl-nav-item">
                    <a href="{{ route('forms.index') }}" class="cl-nav-link {{ request()->routeIs('forms.*') ? 'active' : '' }}">
                        <svg class="cl-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
                        {{-- "Forms" named the thing we built, not the thing the
                             person came to do. Peter's 3rd-pass mockup renames it. --}}
                ...
                {{-- "My Portfolio" was here, built to Rule R53 as the
                     client's public third tier. Removed 2026-08-25 on Ali's
                     instruction: a portfolio is a professional's shop window —
                     work they are selling — and a client is not selling
                     anything. See the decision log; R53 no longer has a
                     surface, which is Sir Peter's to confirm. --}}
            </ul>
        </nav>
