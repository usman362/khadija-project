    ...
    <aside class="cl-sidebar" id="sidebar">
        ...
        <nav class="cl-sidebar-nav">
            <ul style="list-style:none; padding:0;">
                ...
                {{-- "Multi-Service Requests" was a second link to the Bidding Board
                     filtered to multi-service gigs — same query, same page, one more
                     thing in the sidebar. It is the board's scope filter now. --}}
                <li class="cl-nav-item">
                    <a href="{{ route('professional.direct-offers.show') }}" class="cl-nav-link {{ request()->routeIs('professional.direct-offers.*') ? 'active' : '' }}">
                        <svg class="cl-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
                        Direct Requests
                    </a>
                </li>
                ...
                <li class="cl-nav-item">
                    <a href="{{ route('professional.reports.index') }}" class="cl-nav-link {{ request()->routeIs('professional.reports.*') ? 'active' : '' }}">
                        <svg class="cl-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
                        Reports
                    </a>
                </li>
                ...
                {{-- Checklist row 155 — a professional had no way to report a
                     client who never turned up. This is that way. --}}
                <li class="cl-nav-item">
        ...
        {{-- Sir Peter, 2026-09-03: signed in, there was no way back to the
             public site. The logo goes to this portal's dashboard, which is
             right for a workspace and left the homepage unreachable.

             Down here with Contact Support, not at the top: it is a "leave the
             workspace" link, not somewhere you work. --}}
    ...
    <main class="cl-main">
        <header class="pro-topbar">
            ...
            <div class="pro-topbar-right">
                    @include('partials._role_switcher', ['portal' => 'professional'])
