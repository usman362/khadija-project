    ...
    <div class="lp-container lpn-inner">
        ...
        <div class="lpn-links">
            ...
            <div class="lpn-item">
                ...
                <div class="lpn-menu">
                    <a href="{{ route('public.packages') }}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg><span style="display:flex;flex-direction:column;gap:1px;"><span style="font-weight:600;">Browse Packages</span><span style="font-size:11px;color:var(--muted);font-weight:500;">Browse complete event solutions</span></span></a>
