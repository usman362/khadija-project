...
(function () {
    ...
    if (aiUse) aiUse.addEventListener('click', () => {
        const i = $('pm-input');
        if (i) { i.value = "Thank you so much for the great work and smooth coordination! Next steps: I'll confirm the final timeline, share the remaining deliverables, and keep escrow on track. Looking forward to wrapping this up perfectly."; i.focus(); }
    });
