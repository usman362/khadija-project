{{-- Bid negotiation thread + reply/counter form.
     ...
     Hidden until the "Reply / Counter" toggle is clicked. --}}
@php
    $replyRoute = $replyRoute ?? 'professional.bidding-board.reply';
    $meId = $meId ?? auth()->id();
    $decided = in_array($bid->status, ['won', 'declined', 'withdrawn']);
...
<div style="margin-top:10px;">
    ...
    <div id="{{ $threadId }}" style="display:none;margin-top:8px;border-top:1px solid rgba(128,128,128,.2);padding-top:8px;">
        ...
        @unless($decided)
            <form method="POST" action="{{ route($replyRoute, $bid->id) }}" style="display:flex;flex-direction:column;gap:6px;">
                ...
                <div style="display:flex;gap:6px;align-items:center;">
                    ...
                    <input type="text" name="note" maxlength="1000" placeholder="Add a message…"
