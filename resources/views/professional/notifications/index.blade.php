...
<style>
    ...
    .np-back:hover { color: var(--info-text); }
...
@section('content')
<div class="np-wrap">
    <a href="{{ route('professional.profile.index') }}" class="np-back">
        ...
        <div class="np-card">
            ...
            <div class="np-row">
                <div class="np-info">
                    ...
                    <div class="np-desc">New bookings, approvals, and status changes.</div>
                </div>
            ...
            <div class="np-row">
                <div class="np-info">
                    ...
                    <div class="np-desc">Email when a client sends you a message.</div>
                </div>
                <label class="np-switch">
            ...
            <div class="np-row">
                <div class="np-info">
                    <div class="np-title">New Event Opportunities</div>
                    <div class="np-desc">When new events matching your skills are posted.</div>
                </div>
                <label class="np-switch">
