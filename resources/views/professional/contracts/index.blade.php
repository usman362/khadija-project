...
{{-- ════════════════════════════════════════════════════════════════
     ...
     Smart Bid Assistant are derived/illustrative (no escrow ledger /
            ...
            <div class="pc-card">
                ...
                <div class="pc-earn-body">
                    ...
                    <div class="pc-earn-legend">
                        ...
                        <div class="pc-earn-leg"><span class="dot" style="background:#06b6d4;"></span><span class="nm">In Escrow</span><span class="vl">{{ $money($sumEscrow) }}</span> <span class="pc">({{ $pctEscrow }}%)</span></div>
