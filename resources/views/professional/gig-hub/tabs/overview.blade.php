...
<div class="pg">
    ...
    <div class="pg-top">
        ...
        <div class="pg-card">
            ...
            @endforelse
            <a href="{{ route('professional.gig-hub.index', ['tab' => 'gigs']) }}" class="pg-viewall">View All Gigs →</a>
        </div>
    </div>
    ...
    <div class="pg-card" style="margin-bottom:20px;">
        ...
        <div class="pg-bd">
            ...
            <div>
                ...
                <a href="{{ route('professional.gig-hub.index', ['tab' => 'gigs']) }}" class="pg-bd-cta">View All Gigs <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg></a>
