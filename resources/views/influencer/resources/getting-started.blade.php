...
@php
    $tm = [
        ...
        'article'  => ['#15803d','<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>'],
...
<div class="rs-grid" style="grid-template-columns:1fr 1fr 1fr;">
    @foreach([['Browse the Library','Find guides, templates & more','influencer.resources.library','#2563eb','#dbeafe'],['Take a Course','Structured learning in the Academy','influencer.resources.academy','#16a34a','#dcfce7'],['Read Articles','Quick tips from top creators','influencer.resources.articles','#15803d','#dcfce7']] as [$t,$d,$route,$c,$bg])
