...
@php
    $typeMeta = [
        ...
        'tool'      => ['#16a34a', '<path d="M14.7 6.3a4 4 0 0 0-5.4 5.4L3 18l3 3 6.3-6.3a4 4 0 0 0 5.4-5.4l-2.6 2.6-2-2 2.6-2.6z"/>'],
    ...
    $typeColors = ['guide'=>'#2563eb','video'=>'#ef4444','template'=>'#7c3aed','checklist'=>'#16a34a','tool'=>'#16a34a','webinar'=>'#0891b2','article'=>'#15803d'];
    // types donut
