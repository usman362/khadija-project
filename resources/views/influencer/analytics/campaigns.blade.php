...
<div class="an-tiles">
    ...
    <div class="an-tile"><div class="top"><span class="ic" style="background:var(--blue-soft);color:var(--blue);"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.3-4.3"/></svg></span><span class="lbl">Campaign Clicks</span></div><div class="v">{{ $fmt($totalClicks) }}</div><div class="tr" style="font-weight:500;">All campaigns, all time</div></div>
