...
<div class="an-tiles">
    ...
    <div class="an-tile"><div class="top"><span class="ic" style="background:var(--orange-soft);color:var(--orange);"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 11a3 3 0 1 0 6 0 3 3 0 0 0-6 0z"/><path d="M17.7 17.7 22 22"/></svg></span><span class="lbl">Content Clicks</span></div><div class="v">{{ $fmt($totalClicks) }}</div><div class="tr" style="font-weight:500;">From your posts, all time</div></div>
