    ...
    <div>
        ...
        <div class="iv-panel">
            ...
            <div class="iv-share">
                ...
                <a href="mailto:?subject=Join%20GigResource&body=Sign%20up%20with%20my%20link:%20{{ $enc }}"><span class="ic" style="background:#15803d;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 7l-10 7L2 7"/></svg></span><span class="nm">Email</span></a>
    ...
    <div>
        ...
        <div class="iv-rail-card">
            ...
            <div class="iv-rail-list">
                ...
                <div class="it"><svg viewBox="0 0 24 24" fill="none" stroke="#16a34a" stroke-width="2.4"><polyline points="20 6 9 17 4 12"/></svg> Track your performance</div>
            </div>
        </div>
