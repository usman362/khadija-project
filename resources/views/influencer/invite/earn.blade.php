...
<div class="iv-layout" style="margin-top:0;">
    ...
    <div>
        <div class="iv-rail-card">
            ...
            <div class="iv-rail-stat"><div class="m"><div class="l">Pending</div></div><div class="v" style="font-family:var(--ff); font-weight:800; color:#d97706;">${{ number_format($pending, 2) }}</div></div>
        ...
        <div class="iv-rail-card iv-rail-soft">
            ...
            <div class="iv-rail-list">
                ...
                <div class="it"><svg viewBox="0 0 24 24" fill="none" stroke="#f97316" stroke-width="2.4"><polyline points="20 6 9 17 4 12"/></svg> Encourage sign-ups &amp; bookings</div>
            </div>
