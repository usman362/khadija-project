...
<div class="pg-tiles">
    ...
    <div class="pg-tile"><div class="ic" style="background:#dcfce7;color:#b45309;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><div class="v">${{ number_format($totals['pending'], 2) }}</div><div class="l">Pending</div></div>
