...
return [
    ...
    // Suppress the high-volume "expected" exceptions so the Sentry dashboard
    // surfaces real bugs only — 404s, validation failures, CSRF mismatches,
    // auth/authorization denials, and method-not-allowed responses are all
    // user/router noise rather than application errors.
    'ignore_exceptions' => [
